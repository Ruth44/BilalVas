...
$query="SELECT code, title FROM service ORDER BY title";
                            ...
                            <li class="dropdown notification-list list-inline-item">
                                <div class="dropdown notification-list nav-pro-img">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown">
                                      ...
                                      <input class="dropdown-item text-danger" type="submit" name="logout" value="Logout">
       </form>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title">Add Content</h4><br>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                        <h4 class="mt-0 header-title">Available Contents</h4><br>
...
$stat=$connection->prepare("select * from content");
$stat->execute();
    while($row=$stat->fetch()){
        echo "<tr><td>".$row['id']."</td>"."<td>".$row['service_code']."</td>"."<td>".$row['content']."</td>"."<td>".$row['sent']."</td>"."<td>".$row['created_at']."</td>"."<td>".$row['created_by']."</td></tr>";
